...
<html>
    ...
    <body>
                            ...
                            <div class="col-sm-7">
                                <div class="product-information"><!--/product-information-->
                                    ...
                                    <span>
                                        ...
                                        <button type="button" class="btn btn-fefault cart" href="CartServlet?command=insert&productid=<%=pr.getProductID()%>&cartID=<%=System.currentTimeMillis()%>">
        ...
        <script type="text/javascript" language="javascript">
            $(function () {
                $("#small").imageLens({lensSize: 150, bordeColor: "#fff"});
